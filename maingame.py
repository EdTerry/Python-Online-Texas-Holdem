#Hand evaluation code taken from https://gist.github.com/imoran21/72d95f223c1f838a827a
    ...
    if one[0] == two[0]:
        ...
        if one[0] =="STRAIGHT FLUSH":
            ...
            if com == "TIE":
                ...
                return "Player 2", two[0], two[1]
            else:
                return "Player 1", one[0], one[1]
...
def main():
    #PLAYER 1 HAS AC, QH
    #PLAYER 2 HAS 3H, AD
    a = ['3H', '3D', 'KS', 'KH', 'KC', 'AS', 'QS']
    b = ['3C', '3D', '3S', 'KH', '2C', 'AS', 'QS']
